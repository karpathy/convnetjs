...
(function(global) {
  ...
  var Brain = function(num_states, num_actions, opt) {
    ...
    // what epsilon value do we start with?
    this.epsilon = typeof opt.epsilon !== 'undefined' ? opt.epsilon : 1;
    // what decay factor is applied to the epsilon value?
    this.epsilonDecay = typeof opt.epsilonDecay !== 'undefined' ? opt.epsilonDecay : 0.99;
    ...
    forward: function(input_array) {
      ...
      if(this.forward_passes > this.temporal_window) {
        ...
        if(this.learning) {
          ...
          this.epsilon = Math.max(this.epsilon_min, this.epsilon * this.epsilonDecay);
        }
