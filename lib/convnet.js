var convnetjs = (function(exports){
  ...
  */
  ...
  var DropoutLayer = function(out_sx, out_sy, out_depth, drop_prob) {
    this.out_sx = out_sx; 
    this.out_sy = out_sy;
    this.out_depth = out_depth;
    this.layer_type = 'dropout';
    this.drop_prob = 0.5;
    if(typeof(drop_prob)!=='undefined') { this.drop_prob = drop_prob; }
    this.dropped = zeros(out_sx*out_sy*out_depth);
  }
    ...
    makeLayers: function(defs) {
      ...
      for(var i=0;i<defs.length;i++) {
        ...
        if(type === 'fc') {
          ...
          var d = new DropoutLayer(prev.out_sx, prev.out_sy, prev.out_depth, def.drop_prob);
          this.layers.push(d);
