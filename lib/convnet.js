var convnetjs = (function(exports){
  ...
  var Vol = function(sx, sy, depth, c) {
    ...
    var wVal = typeof c === 'undefined' ? randn(0.0, scale) : c;
    this.w = new Float32Array(new ArrayBuffer(length*8));
    this.dw = new Float32Array(new ArrayBuffer(length*8));
  ...
  */ 
  ...
  function zeros(n) {
    ...
    var arr = new Float32Array(new ArrayBuffer(n*8));
