  ...
  */ 
  ...
  SGDTrainer.prototype = {
    train: function(x, y) {
      ...
      // loss is a bit of a hack. Ideally, user should specify arbitreary number of loss functions on any layer
      // and it should all be computed correctly and automatically. 
      return {fwd_time: fwd_time, bwd_time: bwd_time, cost_loss: cost_loss, softmax_loss: cost_loss, decay_loss: decay_loss, loss: cost_loss + decay_loss}
    }
  }
