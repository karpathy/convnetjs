...
layer_defs.push({type:'lstm', filters:10});\n\
layer_defs.push({type:'fc', num_neurons:50, activation:'tanh'});\n\
...
\n\
trainer = new convnetjs.SGDTrainer(net, {learning_rate:1, method:'adadelta', batch_size:1, l2_decay:0.001, l1_decay:0.001});\n\
";
...
var step = function(sample) {
  ...
  train_elt.appendChild(document.createTextNode(t));
  train_elt.appendChild(document.createElement('br'));
  var t = 'Debug: ' + xLossWindow.get_average();
  train_elt.appendChild(document.createTextNode(t));
  train_elt.appendChild(document.createElement('br'));
